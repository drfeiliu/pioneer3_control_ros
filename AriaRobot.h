/**************************************************************************
   Date:      16, May, 2014
   File:      AriaRobot.h
   Function:  the header file for Aria Robot 
...
class RosAriaNode
{
  ...
  public:
    ...
    //192.168.0.119 is the default IP address of local computer
...
RosAriaNode::RosAriaNode(ros::NodeHandle nh) :
  myPublishCB(this, &RosAriaNode::publish), serial_port(""), serial_baud(0), use_sonar(true)
{
  ...
  //added by Fei, 05/16/2014
  cmdvel_sub_p0_119 = n.subscribe( "/RosAria/cmd_vel_p0_119", 10, (boost::function <void(const geometry_msgs::TwistConstPtr&)>)
...
//added by Fei, 05/16/2014
void RosAriaNode::cmdvel_cb_p0_192_168_0_119( const geometry_msgs::TwistConstPtr &msg)
{
  veltime = ros::Time::now();
  ROS_INFO( "new speed: [%0.2f,%0.2f](%0.3f)", msg->linear.x*1e3, msg->angular.z, veltime.toSec() );
